...
from pysat.examples.lbx import LBX #计算MaxSAT解的近似值
from pysat.examples.rc2 import RC2 #MaxSAT求解器
from pysat.formula import CNF, WCNF #MaxSAT问题表示的标准格式，w：权重
...
class MinDS1Rules(SATRules, object):
    ...
    def compute(self):
        ...
        # iterative over the number of terms : term迭代的次数？
        nof_terms = 1
        self.time = 0.0
